...
const Footer = () => {
  return (
    <footer className="bg-orange-500 text-white pt-8 md:pt-0">
      <div className="flex flex-col md:flex-row justify-center gap-5 md:gap-24 p-8 md:px-32 px-5">
        <div className="w-full md:w-1/4 space-y-4">
          ...
          <p className="text-sm">
            NextSphere empowers businesses with innovative web design,
            development, and eCommerce solutions. Let’s bring your vision to
            life.
          </p>
        </div>
        <div>
