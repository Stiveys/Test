        ...
        <div className=" flex flex-row justify-between p-5 md:px-32 px-5 bg-PrimaryColor shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
          <div>
            <Link to="home" spy={true} smooth={true} duration={400}>
              <h1 className=" text-2xl font-semibold text-orange-500 cursor-pointer">
                Shopify</h1>
          ...
          <div className="flex items-center gap-5">
            ...
            <div className=" text-secondaryColor relative">
              <FaShoppingCart
                size={25}
                className=" cursor-pointer"
                onClick={() => setShowCart(true)}
              />
              <div className=" absolute top-[-15px] right-[-10px] bg-green-500 w-[22px] h-[20px] rounded-full text-white text-sm grid place-items-center">
                {cartCount}
              </div>
            </div>
          </div>
